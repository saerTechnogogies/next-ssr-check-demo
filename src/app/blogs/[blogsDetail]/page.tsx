...
export async function generateMetadata({ params }:ParamsProps) {
    ...
    const bdata = (await blogDetail.json());
    return {
      title:bdata.response?.meta_title,
      description:bdata.response?.meta_description,
      keywords:bdata.response?.meta_keyword,
       alternates: {
            canonical: `https://servicetasker.com.au/${bdata.response?.type}/${bdata.response?.slug}/`,
            languages: {
            'en-AU': '/en-AU',
       ...
       openGraph: {
            images: bdata?.response?.image,
            title:bdata?.response?.meta_title,
            description:bdata.response?.meta_description,
            url:`https://servicetasker.com.au/${bdata.response?.type}/${bdata.response?.slug}/`,
            locale: 'en_AU',
            //  types: bdata?.response.type,
      },
    ...
    "@context": "https://schema.org/",
            "@graph": [
              ...
              },
              {
                "@context": "https://schema.org/",
                "@type": "WebPage",
                "@id": `https://servicetasker.com.au/${bdetail?.response?.type}/${bdetail?.response?.slug}/#webpage"`,
                name: bdetail?.response?.title,
                url: `https://servicetasker.com.au/${bdetail?.response?.type}/${bdetail?.response?.slug}/`,
                lastReviewed: "2023-07-20T16:39:27+11:00",
                dateCreated: "2023-07-18T03:41:10+11:00",
                inLanguage: "en-AU",
                description: bdetail?.response?.meta_description,
                reviewedBy: {
                  "@type": "Organization",
                  name: "ServiceTasker",
                  url: `https://servicetasker.com.au/${bdetail?.response?.type}/`,
                  logo: {
                    "@type": "ImageObject",
                    url: "https://www.airtasker.com/blog/wp-content/uploads/2023/01/airtasker-logo.svg",
                    width: "148",
                ...
                primaryImageOfPage: {
                  "@id": `${bdetail?.response?.thumbnail_photo}/#primaryimage`,
                },
              },
              {
                "@type": "Article",
                "@id": `https://servicetasker.com.au/${bdetail?.response?.type}/${bdetail?.response?.slug}/#Article`,
                url: `https://servicetasker.com.au/${bdetail?.response?.type}/${bdetail?.response?.slug}/`,
                inLanguage: "en-AU",
                mainEntityOfPage: `https://servicetasker.com.au/${bdetail?.response?.type}/${bdetail?.response?.slug}//#webpage`,
                headline: bdetail?.response?.title,
                description: bdetail?.response?.meta_description,
                articleBody:
                ...
                image: [
                  ...
                  },
                  {
                    ...
                    height: 800,
                    caption:
                      "living space combined with a teen's sleeping area",
                  },
                  {
                    "@type": "ImageObject",
